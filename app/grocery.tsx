    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'rgb(58,58,58)', paddingBottom: StatusBar.currentHeight}}>
      <View style={styles.column}>
        ...
        <View style={{...styles.row,backgroundColor:'rgb(58,58,58)',padding:10}}>
          <TextInput style={{...styles.buttonInput, flex:1,marginRight:10,paddingLeft:20,paddingRight:20}} placeholder="Add to grocery"></TextInput>
          <TouchableOpacity style={{...styles.buttonInput,aspectRatio:1}}>
        ...
        <View style={{...styles.row,paddingTop:10,paddingBottom:10,borderTopWidth:2}}>
          ...
          <View style={{...styles.typeFilter,borderRightWidth:0}}><Text style={{...styles.boldText,textDecorationLine: 'underline'}} onPress={()=>{router.navigate('/grocery')}} >Grocery</Text></View>
        </View>
        <View style={{...styles.row,backgroundColor:'rgb(58,58,58)',padding:10}}>
