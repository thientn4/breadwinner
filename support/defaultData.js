    ...
    defaultRecipes:[
        {
            ...
            { "name": "chicken broth", "quantity": "2-3 cups" },
            { "name": "cilantro", "quantity": "1/2 cup" },
            { "name": "dried oregano", "quantity": "1/2 tsp" },
            { "name": "garlic cloves", "quantity": "4-6" },
            { "name": "ground cumin", "quantity": "1 tsp" },
            { "name": "jalapeño peppers", "quantity": "1-2" },
            { "name": "lime juice", "quantity": "1-2 tbsp" },
            { "name": "oil", "quantity": "2 tbsp" },
            { "name": "poblano peppers", "quantity": "2" },
            { "name": "pork shoulder", "quantity": "3 lbs" },
            { "name": "salt", "quantity": "1 1/2 tsp" },
            { "name": "serrano peppers", "quantity": "1" },
            { "name": "tomatillos", "quantity": "2 lbs" },
        ...
        },
        {
            ...
            "type": 2,
            "ingredients": [
            {'name': 'cream cheese', 'quantity': '32 oz (4 blocks)'},
        ...
        },
        {
            ...
            { "name": "cloves", "quantity": "6-8" },
            { "name": "coriander seeds", "quantity": "2 tbsp" },
            { "name": "cumin seeds", "quantity": "1 tbsp" },
            { "name": "dried red chilies", "quantity": "8-12" },
            { "name": "fresh ginger", "quantity": "2-inch piece" },
            { "name": "garlic cloves", "quantity": "10-12" },
            { "name": "green cardamom pods", "quantity": "4-6" },
            ...
            { "name": "vegetable oil or ghee", "quantity": "3 tbsp" },
        ...
        },
        {
            ...
            { "name": "large onion", "quantity": "1, chopped" },
            { "name": "red bell pepper", "quantity": "1, chopped" },
            { "name": "garlic cloves", "quantity": "3-4, minced" },
            { "name": "canned crushed tomatoes", "quantity": "1 (28 ounce) can" },
            { "name": "tomato paste", "quantity": "1 tbsp" },
            { "name": "smoked paprika", "quantity": "1 tsp" },
            { "name": "cumin", "quantity": "1 tsp" },
            { "name": "chili powder", "quantity": "1/2 tsp (optional)" },
            { "name": "salt", "quantity": "1/2 tsp, or to taste" },
            { "name": "black pepper", "quantity": "1/4 tsp, or to taste" },
            { "name": "eggs", "quantity": "4-6" },
            { "name": "fresh parsley or cilantro", "quantity": "chopped, for garnish" },
            { "name": "feta cheese", "quantity": "crumbled, for serving (optional)" }
            ],
            "instruction": `
            Heat olive oil in a large, deep skillet or cast-iron pan over medium heat.\n    
            Add the chopped onion and bell pepper and sauté for 8-10 minutes, until softened.\n    
            Add the minced garlic and cook for another minute until fragrant.\n    
            Stir in the crushed tomatoes, tomato paste, smoked paprika, cumin, and chili powder (if using). Bring the sauce to a simmer.\n    
            Season with salt and black pepper to taste. Reduce the heat to low, cover, and let it simmer for 15-20 minutes, allowing the flavors to meld and the sauce to thicken slightly.\n    
            Using a spoon, make 4-6 small wells in the tomato sauce. Carefully crack one egg into each well.\n    
            Cover the skillet and cook for 8-12 minutes, or until the egg whites are set and the yolks are still runny (or cooked to your preference).\n    
